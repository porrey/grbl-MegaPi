...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 177.800
  #define DEFAULT_Y_STEPS_PER_MM 177.800
  #define DEFAULT_Z_STEPS_PER_MM 250.000
  #define DEFAULT_X_MAX_RATE 3000.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 3000.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 500.0 // mm/min
  #define DEFAULT_X_ACCELERATION (50.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (50.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (10.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 340.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 360.0 // mm
  #define DEFAULT_Z_MAX_TRAVEL 0.0 // mm
